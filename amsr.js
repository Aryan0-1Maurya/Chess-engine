    ...
    if (myTurn) {
      ...
      if (!moveable) {
        ...
        if (moveScopes.indexOf(String(n)) >= 0) {
          ...
          function amsrSaveKing(){
            Swal.fire({
                icon: 'warning',
                title: 'Oops...',
                text: 'Save your King ',
                footer: '<a href="https://amsrportfolio.netlify.app/">Improve your Skill </a>'
              })
        }
          if (!saveKing) {
  ...
  function chooseTurn() {
    ...
    function amsrWin(){
        Swal.fire({
            ...
            icon: 'success',
            title: 'Well Done ! you WoN the match',
    ...
    if (bestMove) {
      values[Number(bestMove.split("-")[1])] =
        values[Number(bestMove.split("-")[0])];
      values[Number(bestMove.split("-")[0])] = 0;
      if (
        values[Number(bestMove.split("-")[1])] === "p" &&
